...
// If a terminal is running when you build this below, you will need to close it and run a new 'npm start'
...
// Initialize authentication from firebase - the code we write below should remind you to connect authentication from 
// firebase to an OAuth app in GitHub (we go to GitHub.com to create this)
